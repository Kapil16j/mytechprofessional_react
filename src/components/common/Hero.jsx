...
const Hero = ({ title }) => {
  return (
    ...
    <div className=" bg-center bg-origin-content bg-no-repeat xl:h-[650px] h-[480px] w-full bg-cover">

      <div className="max-w-[1140px] h-full flex flex-col justify-center items-center mx-auto px-3 xl:px-0">
        <h1 className="font-extrabold leading-[70px] text-[40px] sm:text-[63px] text-black">
          {title}
        </h1>
